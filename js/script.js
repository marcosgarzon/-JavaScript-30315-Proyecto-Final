// AUTOEJECUTABLE, CAMBIA SEGÚN EL DÍA DE LA SEMANA
(() => {
  let tiempo = new Date();
  let semana = tiempo.getDay();
  if (semana == 0) {
    document.getElementById("ofert").innerHTML = "<p> Domingo </p>";
  } else if (semana == 1) {
    document.getElementById("ofert").innerHTML = "<p> Lunes </p>";
  } else if (semana == 2) {
    document.getElementById("ofert").innerHTML = "<p> Martes </p>";
  } else if (semana == 3) {
    document.getElementById("ofert").innerHTML = "<p> Miércoles </p>";
  } else if (semana == 4) {
    document.getElementById("ofert").innerHTML = "<p> Jueves </p>";
  } else if (semana == 5) {
    document.getElementById("ofert").innerHTML = "<p> Viernes </p>";
  } else {
    document.getElementById("ofert").innerHTML = "<p> Sábado </p>";
  }
})();
